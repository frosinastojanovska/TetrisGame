...
##1. <a name="introduction"></a>Опис на апликацијата
...
##2. <a name="functionalities"></a>Претставување на функционалностите
...
###2.4. <a name="game"></a>Начин на игра
...
##3. <a name="problem"></a>Претставување на проблемот

###3.1 <a name="classes"></a>Класи
...
###3.3. <a name="controls"></a>Контроли
