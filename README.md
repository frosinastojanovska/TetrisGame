...
####Table of Contents
 ...
 2. [Претставување на функционалностите](#functionalities)
   ...
   2.4. [Начин на игра](#game)
   
 3. [Претставување на проблемот](#problem)
 
   3.1. [Класи](#classes)

   3.2. [Форми](#forms)
   
   3.3. [Контроли](#controls)
   


##1. Опис на апликацијата<a name="introduction"></a>
...
##2. Претставување на функционалностите<a name="functionalities"></a>
...
###2.1. Playing Game<a name="playing"></a>
...
###2.3. End Game<a name="end-game"></a>
...
###2.4. Начин на игра<a name="game"></a>
...
##3. Претставување на проблемот<a name="problem"></a>

###3.1 Класи<a name="classes"></a>

####3.1.1. Square<a name="square"></a>
...
###3.3. Контроли<a name="controls"></a>
